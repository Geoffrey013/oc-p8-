...
describe('controller', function () {
    ...
    describe('toggle all', function () {
        it('should toggle all todos to completed', function () {
            // TODO: write test
            var todos = [{id: 21, title: 'todo1', completed: false}, {id: 22, title: 'todo2', completed: false}];
        ...
        it('should update the view', function () {
            // TODO: write test
            var todos = [{id: 21, title: 'todo1', completed: true}, {id: 22, title: 'todo2', completed: true}];
